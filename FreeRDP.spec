...
Version  : 2.3.1
Release  : 28
URL      : https://github.com/FreeRDP/FreeRDP/archive/2.3.1/FreeRDP-2.3.1.tar.gz
Source0  : https://github.com/FreeRDP/FreeRDP/archive/2.3.1/FreeRDP-2.3.1.tar.gz
...
%prep
%setup -q -n FreeRDP-2.3.1
cd %{_builddir}/FreeRDP-2.3.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614813658
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/FreeRDP-2.3.1/LICENSE %{buildroot}/usr/share/package-licenses/FreeRDP/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/FreeRDP-2.3.1/winpr/libwinpr/sysinfo/cpufeatures/NOTICE %{buildroot}/usr/share/package-licenses/FreeRDP/ec4468ecfe59c46406d4fc5aca1cee2a83c4d93e
pushd clr-build
%make_install
popd
...
/usr/lib64/libfreerdp-client2.so.2.3.1
/usr/lib64/libfreerdp-server2.so.2
/usr/lib64/libfreerdp-server2.so.2.3.1
/usr/lib64/libfreerdp-shadow-subsystem2.so.2
/usr/lib64/libfreerdp-shadow-subsystem2.so.2.3.1
/usr/lib64/libfreerdp-shadow2.so.2
/usr/lib64/libfreerdp-shadow2.so.2.3.1
/usr/lib64/libfreerdp2.so.2
/usr/lib64/libfreerdp2.so.2.3.1
/usr/lib64/libuwac0.so.0
/usr/lib64/libuwac0.so.0.1.1
/usr/lib64/libwinpr-tools2.so.2
/usr/lib64/libwinpr-tools2.so.2.3.1
/usr/lib64/libwinpr2.so.2
/usr/lib64/libwinpr2.so.2.3.1
